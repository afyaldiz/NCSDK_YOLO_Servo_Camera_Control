...
R2 = Radiobutton(top, text="aeroplane", variable=radio, value=2,command=selection)  
R2.pack(anchor=W)


R3 = Radiobutton(top, text="bicycle", variable=radio, value=3,command=selection)  
R3.pack(anchor=W)

R4 = Radiobutton(top, text="bird", variable=radio, value=4,command=selection)
R4.pack(anchor=W)

R5 = Radiobutton(top, text="boat", variable=radio, value=5,command=selection)  
R5.pack(anchor=W)

R6 = Radiobutton(top, text="boottle", variable=radio, value=6,command=selection)  
R6.pack(anchor=W)

R7 = Radiobutton(top, text="bus", variable=radio, value=7,command=selection)  
R7.pack(anchor=W)

R8 = Radiobutton(top, text="car", variable=radio, value=8,command=selection)  
R8.pack(anchor=W) 

R9 = Radiobutton(top, text="cat", variable=radio, value=9,command=selection)  
R9.pack(anchor=W) 

R10 = Radiobutton(top, text="chair", variable=radio, value=10,command=selection)  
R10.pack(anchor=W) 

R11 = Radiobutton(top, text="cow", variable=radio, value=11,command=selection)  
R11.pack(anchor=W)

R12 = Radiobutton(top, text="diningtable", variable=radio, value=12,command=selection)  
R12.pack(anchor=W)

R13 = Radiobutton(top, text="dog", variable=radio, value=13,command=selection)  
R13.pack(anchor=W)

R14 = Radiobutton(top, text="horse", variable=radio, value=14,command=selection)  
R14.pack(anchor=W)

R15 = Radiobutton(top, text="motorbike", variable=radio, value=15,command=selection)  
R15.pack(anchor=W)

R16 = Radiobutton(top, text="person", variable=radio, value=16,command=selection)  
R16.pack(anchor=W)

R17 = Radiobutton(top, text="pottedplant", variable=radio, value=17,command=selection)  
R17.pack(anchor=W)

R18 = Radiobutton(top, text="sheep", variable=radio, value=18,command=selection)  
R18.pack(anchor=W)

R19 = Radiobutton(top, text="sofa", variable=radio, value=19,command=selection)  
R19.pack(anchor=W)

R20 = Radiobutton(top, text="train", variable=radio, value=20,command=selection)  
R20.pack(anchor=W)

R21 = Radiobutton(top, text="tvmonitor", variable=radio, value=21,command=selection)  
R21.pack(anchor=W)


liste=("background", "aeroplane", "bicycle", "bird","boat", "bottle", "bus", "car", "cat", "chair", "cow","diningtable", "dog", "horse", "motorbike", "person","pottedplant", "sheep", "sofa", "train", "tvmonitor")
...
print("[BILGI] cihaz {} bulundu. device0 de kullanilabilir." "cihaz aciliyor...".format(len(devices)))
...
#				sirali_kare.sort(reverse=True)
				...
				if pred_conf > args["confidence"]:
					...
					if args["display"] > 0:
						...
						cv2.putText(image_for_result, label, (startX, y),cv2.FONT_HERSHEY_SIMPLEX, 1, COLORS[pred_class], 3)
